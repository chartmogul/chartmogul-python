...
class PlanTestCase(unittest.TestCase):
    ...
    def test_cursor_list_plans(self, mock_requests):
        expected_plan_dict = {"uuid": "whatever_uuid", "data_source_uuid": "some_uuid", "name": "some plan", "interval_count": 2, "interval_unit": "moonshines", "external_id": "custom_filter"}
        mock_requests.register_uri(
            'GET',
            "https://api.chartmogul.com/v1/plans?page=5&per_page=12&data_source_uuid=some_uuid&external_id=custom_filter",
        ...
        plan = Plan.all(config, page=5, per_page=12, data_source_uuid="some_uuid", external_id="custom_filter").get()
    ...
    def test_modify_plan(self, mock_requests):
        expected_plan_dict = {"uuid": "whatever_uuid", "data_source_uuid": "some_uuid", "name": "new_name", "interval_count": 2, "interval_unit": "moonshines", "external_id": "custom_filter"}
        mock_requests.register_uri(
            'PATCH',
