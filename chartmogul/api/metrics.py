...
class Metrics(Resource):
    ...
    class _Schema(Schema):
        ...
        mrr = fields.Integer()
        # MRR only
        mrr_new_business = fields.Integer(data_key="mrr-new-business")
        mrr_expansion = fields.Integer(data_key="mrr-expansion")
        mrr_contraction = fields.Integer(data_key="mrr-contraction")
        mrr_churn = fields.Integer(data_key="mrr-churn")
        mrr_reactivation = fields.Integer(data_key="mrr-reactivation")
        percentage_change = fields.Float(data_key="percentage-change")
        for metric in metrics:
            pc = metric + "-percentage-change"
            locals()[pc.replace("-", "_")] = fields.Float(data_key=pc)
